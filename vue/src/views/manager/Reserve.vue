<template>
  <div>
    <div class="search">
      <el-input placeholder="请输入家长姓名" style="width: 200px" v-model="userName"></el-input>
      <el-input placeholder="请输入教师姓名" style="width: 200px; margin-left: 5px" v-model="teacherName"></el-input>
