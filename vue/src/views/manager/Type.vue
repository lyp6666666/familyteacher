  ...
  <div>
    ...
    <div class="table">
      <el-table :data="tableData" stripe  @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="img" label="分类图标" show-overflow-tooltip>
        ...
        <el-table-column prop="type" label="分类小类"></el-table-column>
    ...
    <el-dialog title="家教分类" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form label-width="100px" style="padding-right: 50px" :model="form" :rules="rules" ref="formRef">
        ...
        <el-form-item prop="type" label="分类小类">
          <el-select v-model="form.type" placeholder="请选择" style="width: 100%">
            <el-option label="普通文化课" value="普通文化课"></el-option>
            <el-option label="兴趣拔高课" value="兴趣拔高课"></el-option>
          </el-select>
        </el-form-item>
      </el-form>
